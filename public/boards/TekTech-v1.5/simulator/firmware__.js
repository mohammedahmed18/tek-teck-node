...
var ASM_CONSTS = {
  45400: function() {return simSystem.getCharsLenWaitProcass();},  
 45447: function() {return simSystem.getAndPopFirstCharsWaitProcass();},  
 45502: function($0) {return simSystem.isCharsWaitProcassHasInterruptChar($0)},  
 45952: function() {if (typeof simSystem !== "undefined") { try { return simSystem.ldr.getValue(); } catch(err) { console.log(err); } } return 0;},  
 46082: function() {if (typeof simSystem !== "undefined") { try { return simSystem.lm75.getValue() * 100; } catch(err) { console.log(err); } } return 0;},  
 47740: function($0) {return simSystem.pin.analogRead($0);},  
 48484: function($0) {return simSystem.pin.digitalRead($0);},  
 48526: function($0, $1) {simSystem.pin.digitalWrite($0, $1);},  
 48776: function($0) {return simSystem.pin.touchRead($0);},  
 49008: function($0, $1) {simSystem.pin.analogWrite($0, $1);},  
 49264: function($0, $1) {const buf = $0; const len = $1; let data = [ ]; for (let i=0;i<len;i++) { data.push(HEAPU8[buf + i]); } for (let i=0;i<len-16;i++) { data.push(0); } if (typeof simSystem !== "undefined") { try { simSystem.display.setData(data); } catch(err) { console.log(err); } } else { console.log("Display data", data); }},  
 49616: function() {return simSystem.switch[0].value;},  
 49654: function() {return simSystem.switch[1].value;},  
 49692: function() {return simSystem.switch[2].value;},  
 49730: function() {return simSystem.switch[3].value;}
};
