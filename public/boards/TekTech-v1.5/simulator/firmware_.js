...
var ASM_CONSTS = {
  45396: function() {return simSystem.getCharsLenWaitProcass();},  
 45443: function() {return simSystem.getAndPopFirstCharsWaitProcass();},  
 45498: function($0) {return simSystem.isCharsWaitProcassHasInterruptChar($0)},  
 45948: function() {if (typeof simSystem !== "undefined") { try { return simSystem.ldr.getValue(); } catch(err) { console.log(err); } } return 0;},  
 46078: function() {if (typeof simSystem !== "undefined") { try { return simSystem.lm75.getValue() * 100; } catch(err) { console.log(err); } } return 0;},  
 47324: function($0) {return simSystem.pin.analogRead($0);},  
 48068: function($0) {return simSystem.pin.digitalRead($0);},  
 48110: function($0, $1) {simSystem.pin.digitalWrite($0, $1);},  
 48360: function($0) {return simSystem.pin.touchRead($0);},  
 48592: function($0, $1) {simSystem.pin.analogWrite($0, $1);},  
 48848: function($0, $1) {const buf = $0; const len = $1; let data = [ ]; for (let i=0;i<len;i++) { data.push(HEAPU8[buf + i]); } for (let i=0;i<len-16;i++) { data.push(0); } if (typeof simSystem !== "undefined") { try { simSystem.display.setData(data); } catch(err) { console.log(err); } } else { console.log("Display data", data); }},  
 49200: function() {return simSystem.switch[0].value;},  
 49238: function() {return simSystem.switch[1].value;},  
 49276: function() {return simSystem.switch[2].value;},  
 49314: function() {return simSystem.switch[3].value;}
};
